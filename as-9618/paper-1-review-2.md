...
2. Explain how a packet can travel between two hosts in a mesh topology and why this provides resilience. **[3]**
...
4. Explain how a parity block check can detect an error during data transfer. **[2]**
...
3. Distinguish an FSF-style free-software licence from a commercial software licence. **[2]**
...
2. A mesh topology provides more than one possible route between hosts **[1]**; an intermediate device uses the destination information to select a route/next hop **[1]**; if one link fails, a packet can use an alternative route **[1]**. **[3]**
...
4. Each row/byte has a parity bit and the column parity bits form an additional parity byte **[1]**; the receiver recalculates/checks the parity and a mismatch shows that an error occurred **[1]**. **[2]**
...
3. An FSF-style licence protects freedoms to run, study, modify and share the software/source **[1]**; a commercial licence is normally proprietary and restricts copying, modification or redistribution, often in return for payment **[1]**. **[2]**
